...
function checkDiv(div) {
  ...
  try {
    if (div.className.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("-ad") || div.className.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("ad-") || div.className.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("_ad") || div.className.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("ad_") || div.className.toLowerCase().includes("adsbygoogle") || div.className.toLowerCase().includes("adthrive") || div.className.toLowerCase().includes("pagead") || div.className.toLowerCase().includes("adwidget")) {
      div.remove();
      return;
    }
  } catch (error) {}
  try {
    if (div.id.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("-ad") || div.id.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("ad-") || div.id.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("_ad") || div.id.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("ad_") || div.id.toLowerCase().includes("adsbygoogle") || div.id.toLowerCase().includes("adthrive") || div.id.toLowerCase().includes("pagead") || div.id.toLowerCase().includes("adwidget")) {
      div.remove();
      return;
    }
  } catch (error) {}
  ...
  try {
    if (div.className.toLowerCase() === "banner") {
      div.remove();
      return;
    }
  } catch (error) {}
  try {
    if (div.id.toLowerCase() === "banner") {
      div.remove();
      return;
    }
  } catch (error) {}
...
function checkImage(img) {
  try {
    if (img.src.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("-ad") || img.src.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("ad-") || img.src.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("_ad") || img.src.toLowerCase().replace(/load/g, "").replace(/head/g, "").includes("ad_") || img.src.toLowerCase().includes("adsbygoogle") || img.src.toLowerCase().includes("adthrive") || img.src.toLowerCase().includes("pagead") || img.src.toLowerCase().includes("adwidget")) {
      img.remove();
      return;
    }
  } catch (error) {}
